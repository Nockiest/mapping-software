...
import { DrawAction, DrawingState, ErasePayload, FrontLineSettings, MarkerArraySignal, MarkerSettings, Settings, TimelineType } from "@/public/types/OtherTypes";
...
export const timeline = signal<TimelineType>([])